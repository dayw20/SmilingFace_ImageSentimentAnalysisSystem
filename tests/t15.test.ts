...
import { delay, sendTestRequestAndGetFinishedJob } from '../tests_util/helpers.js';

test.serial('[15] should report errors (failed wikipedia connection)', async (t) => {
    ...
    t.truthy(r2.done)
    t.falsy(typeof r2.error === "undefined")
})